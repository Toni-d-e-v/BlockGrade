...
export function SimpleFooter() {
    ...
    return (
        <footer className='flex border-t fixed justify-center items-center  bottom-0 w-full gap-5 p-2 backdrop-blur-sm '>
            ...
            <p className=" text-foreground"> BlockGrade - E-Diploma - Projekt za
            <Button variant={"link"}><a href="https://skole.hackathon.sum.ba" className="">Code Challenge Hackathon by SUMIT</a></Button> </p>
        </footer>
    );
}